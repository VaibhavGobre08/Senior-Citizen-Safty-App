...
public class ServiceMine extends Service {
    ...
    public void onCreate() {
        ...
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ...
            //   public void onRequestPewrmissionsResult(int requestCode, String[] permissions,
            //                                          int[] grantResults)
        ...
        ShakeDetector.create(this, () -> {
            ...
            if(!ENUM.equalsIgnoreCase("NONE")){
                manager.sendTextMessage(ENUM,null,"Hello Child!\nIm in Trouble!\nSending My Location :\n"+myLocation,null,null);
            }
            ...
            if (intent.getAction().equalsIgnoreCase("STOP")) {
                ...
                if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
                    ...
                    Notification notification = new Notification.Builder(this, "MYID")
                            .setContentTitle("Senior Citizen Safety")
                            .setContentText("Shake Device in Emergency")
